...
('Female',41000011,'Zomorroda Heshmat','13-12-1993',1000011,'1000011@eng.asu.edu.eg' ,'abcd'),
('Female',41000012,'Gawhara Hekmat','14-12-1993',1000012,'1000012@eng.asu.edu.eg' ,'abcd'),
('Female',41000013,'Loloaa Medhat','15-12-1993',1000013,'1000013@eng.asu.edu.eg' ,'abcd'),
('Female',41000014,'Fadda Shawkat','16-12-1993',1000014,'1000014@eng.asu.edu.eg' ,'abcd'),
('Female',41000015,'Zahaba Effat','17-12-1993',1000015,'1000015@eng.asu.edu.eg' ,'abcd');"

#TAs
connection.execute"INSERT INTO PERSON (sex,ssn,name,birthdate,person_id,email,password)
VALUES
('Male',42000001,'Fadl Hasaneen','3-11-1985',2000001,'2000001@eng.asu.edu.eg' ,'abcd'),
('Male',42000002,'Ez Hasaneen','4-11-1985',2000002,'2000002@eng.asu.edu.eg' ,'abcd'),
('Male',42000003,'Nasr Hasaneen','5-11-1985',2000003,'2000003@eng.asu.edu.eg' ,'abcd'),
('Male',42000004,'Tamkeen Hasaneen','6-11-1985',2000004,'2000004@eng.asu.edu.eg' ,'abcd'),
('Male',42000005,'Shaheen Hasaneen','7-11-1985',2000005,'2000005@eng.asu.edu.eg' ,'abcd'),
('Female',42000006,'Fadela Hasaneen','8-11-1985',2000006,'2000006@eng.asu.edu.eg' ,'abcd'),
('Female',42000007,'Azza Hasaneen','9-11-1985',2000007,'2000007@eng.asu.edu.eg' ,'abcd'),
('Female',42000008,'Nasra Hasaneen','10-11-1985',2000008,'2000008@eng.asu.edu.eg' ,'abcd'),
('Female',42000009,'Tamkeena Hasaneen','11-11-1985',2000009,'2000009@eng.asu.edu.eg' ,'abcd'),
('Female',42000010,'Shaheena Hasaneen','12-11-1985',2000010,'2000010@eng.asu.edu.eg' ,'abcd');
"

#Professor
connection.execute"INSERT INTO PERSON (sex,ssn,name,birthdate,person_id,email,password)
VALUES
('Male',43000001,'Kareem Ibraheem','3-10-1985',3000001,'3000001@eng.asu.edu.eg' ,'abcd'),
('Male',43000002,'Sameer Ibraheem','4-10-1985',3000002,'3000002@eng.asu.edu.eg' ,'abcd'),
('Male',43000003,'Azeeza Ibraheem','5-10-1985',3000003,'3000003@eng.asu.edu.eg' ,'abcd'),
('Female',43000004,'Kareema Ibraheem','6-10-1985',3000004,'3000004@eng.asu.edu.eg' ,'abcd'),
('Female',43000005,'Sameera Ibraheem','7-10-1985',3000005,'3000005@eng.asu.edu.eg' ,'abcd'),
('Female',43000006,'Azeeza Ibraheem','8-10-1985',3000006,'3000006@eng.asu.edu.eg' ,'abcd');"
...
VALUES
(3000001,41,81),(3000002,41,82),
(3000001,41,83),(3000002,41,84),
(3000001,41,82),(3000001,42,83),
(3000002,42,84),(3000001,43,82),
(3000002,43,81),
...
VALUES
-- CSE
(2000001,41,81),(2000002,41,82),
(2000003,41,83),(2000002,41,84),
(2000004,41,82),(2000004,41,81),
(2000003,42,83),(2000002,42,84),
(2000001,43,82),(2000002,43,81),
-- ECE
